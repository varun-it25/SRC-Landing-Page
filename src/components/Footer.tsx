...
const Footer = () => {
  return (
    <footer className='p-8 bg-black text-white sm:space-y-0 space-y-5 flex-col sm:flex-row flex justify-between items-center'>
      ...
      <p className='text-center text-zinc-600 whitespace-nowrap ml-[-1rem] sm:ml-0'>©2025 All right reserved. <span className='font-semibold text-zinc-500'>Spiritual Research Cell</span></p>
