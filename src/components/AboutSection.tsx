  ...
  return (
    <section className='flex-col bg-blue-50 h-fit sm:h-[90vh] justify-between items-center sm:flex-row flex space-x-6 px-5 md:px-20 sm:px-12 py-7 sm:py-12'>
      ...
      <div className='w-full flex flex-col justify-center items-start pr-[1.4rem] sm:pr-0 pl-0 sm:pl-6'>
        ...
        <p className='text-zinc-500 text-xs mb-4 text-justify'>We aim to cultivate a values-based community dedicated to personal and collective growth, inspiring youth to embrace spirituality and integrate timeless values into their lives.</p>
        <p className='text-zinc-500 text-xs mb-4 text-justify'>Join us on this transformative journey and experience inner peace, empowerment, and holistic development. Together, let’s build a future where spirituality is a guiding force for a better world.</p>
