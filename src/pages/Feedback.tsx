...
import {  IdCard, Loader2, Phone, RotateCw, ScanFace, User } from 'lucide-react';
...
const Success = () => (
  <div className='w-full h-full flex justify-center items-center'>
    <div className="w-80 sm:w-96 bg-green-200 text-center p-6 rounded-lg">
      <p className="font-semibold text-xl">Feedback Sent Successfully!</p>
      <p className="mt-4 text-sm">Redirecting to home...</p>
      {/* Optionally, you can remove the Home button if you want an entirely automatic redirect */}
...
const Feedback = () => {
  ...
  // Automatically redirect after a successful submission
  useEffect(() => {
    if (status === 'success') {
  ...
  async function submit() {
    ...
    try {
      await axios.post(`${backendUrl}/add-feedback`, { 
        event_id: id, 
        name: fullName, 
          ...
          <section>
            ...
            <div className='border-t-4 border-zinc-400 border w-full rounded-lg mb-5 sm:mb-6 p-6 sm:p-10'>
              ...
              <div className='py-2 sm:py-6 space-y-8'>                       
                ...
                <div className='space-y-3'>
                  <p className='text-sm font-medium text-zinc-800 flex items-center space-x-3'>
                    <IdCard size={18} /><span>RTU Roll No.</span>
                  </p>
                ...
                <div className='space-y-3'>
                  <p className='text-sm font-medium flex text-zinc-800 items-center space-x-3'>
                    <Phone size={18} /><span>Mobile No.</span>
                  </p>
                ...
                <div className='space-y-3'>
                  <p className='text-sm font-medium text-zinc-800 flex items-center space-x-3'>
                    <ScanFace size={18} /><span>Rate your experience</span>
                  </p>
